...
public class Faver_MyAdapter extends BaseAdapter{
    List<faver_music_item> list;
    LayoutInflater inflater;
    Activity activity;

    public Faver_MyAdapter() {
    }

    public Faver_MyAdapter(Activity activity, List<faver_music_item> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.faver_music_item, parent, false);
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            convertView.setLayoutParams(layoutParams);
        }

        ImageView imageView = (ImageView) convertView.findViewById(R.id.iv_Music);
        ...
        TextView artist = (TextView) convertView.findViewById(R.id.txt_Singer);
